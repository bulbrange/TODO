...
public class TaskButtonPanel extends JPanel{
	...
	public TaskButtonPanel(){
		...
		createTask = new CreateButton("Create Task",80,10,MainFrame.device,this);
		deleteTask = new DeleteButton("Delete Task",240,10,MainFrame.device,this);
		finishTask = new FinishButton("Finish Task",440,10,MainFrame.device,this);
		modifyTask = new ModifyButton("Modify Task",600,10,MainFrame.device,this);
